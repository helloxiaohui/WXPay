    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        appayBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Toast.makeText(PayActivity2.this, "获取订单中...", Toast.LENGTH_SHORT).show();
                try {
                    ...
                    if (buf != null && buf.length > 0) {
                        ...
                        if (null != json && !json.has("retcode")) {
                            ...
                            Toast.makeText(PayActivity2.this, "正常调起支付", Toast.LENGTH_SHORT).show();
                            // 在支付之前，如果应用没有注册到微信，应该先调用IWXMsg.registerApp将应用注册到微信
                            //api.registerApp(req.appId);
                            api.sendReq(req);
                        } else {
                            Log.d("PAY_GET", "返回错误" + json.getString("retmsg"));
                            Toast.makeText(PayActivity2.this, "返回错误" + json.getString("retmsg"), Toast.LENGTH_SHORT).show();
                        }
                    } else {
                    ...
                    Toast.makeText(PayActivity2.this, "异常：" + e.getMessage(), Toast.LENGTH_SHORT).show();
                }
        ...
        checkPayBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Toast.makeText(PayActivity2.this, String.valueOf(isPaySupported), Toast.LENGTH_SHORT).show();
            }
        });
    }
